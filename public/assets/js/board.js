function templateBoard(element) {
    return `<tr style="background:rgba(144, 144, 144, 0.25);">
    <td><a id="${element.val().newPostKey}" style="color: white;text-decoration:none;">${element.val().title}</a></td>
    <td style="text-align:right"><a id="${element.val().newPostKey}" style="color: white;text-decoration:none">${element.val().createdAt}</a></td>
    </tr>
...
$(document).ready(function () {
    ...
    ref.orderByChild('reverseCreatedAt').limitToFirst(5).once("value", function (data) {
